...
def test_renders_example_request_body_recursive_references(
        testrenderer, oas_fragment, foo, expected
):
    """References are resolved when rendering json schema example."""
